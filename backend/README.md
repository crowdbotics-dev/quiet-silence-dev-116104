...
## Project Structure
    ...
    ├── quiet_silence_dev_116104  # Django project configurations
...
1. Clone this repo and `cd quiet_silence_dev_116104`
...
2. Clone this repo and `cd quiet_silence_dev_116104`
